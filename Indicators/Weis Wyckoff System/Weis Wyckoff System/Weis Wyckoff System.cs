...
using static cAlgo.WeisWyckoffSystem;
using System;
using System.Linq;
...
namespace cAlgo
{
    ...
    public class WeisWyckoffSystem : Indicator
    {
    ...
    {
        private readonly WeisWyckoffSystem Outside;
        ...
        public ParamsPanel(WeisWyckoffSystem indicator, IndicatorParams defaultParams)
        {
            Outside = indicator;
