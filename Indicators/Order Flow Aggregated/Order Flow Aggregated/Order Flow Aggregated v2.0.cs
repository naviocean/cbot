        ...
        */
        ...
        private void OrderFlow(int iStart)
        {
            ...
            if (isRenkoChart && ShowWicks)
            {
                ...
                DateTime nextOpenTime = (iStart + 1 < Bars.Count) ? Bars.OpenTimes[iStart + 1] : TicksOHLC.LastBar.OpenTime;
            ...
            double maxLength_RightSide = (!IsLastBar || BooleanUtils.isPriceBased_NewBar) && iStart + 1 < Bars.Count ?
        ...
        private void CreateRect_Spike(double p1, double p2, int index, int i, string spikeDictKey, Color color)
        {
            ChartRectangle rectangle = Chart.DrawRectangle(
                ...
                p1,
                (index + 1 < Bars.Count ? Bars.OpenTimes[index + 1] : TicksOHLC.LastBar.OpenTime),
                p2,
